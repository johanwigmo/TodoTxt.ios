...
struct FileLineTests {
    ...
    @Test("Serialize updated todo item")
    func serializeUpdatedTodoItem() {
        let originalTodo = Todo(title: "Original todo", isCompleted: false)
        let line = FileLine(lineNumber: 0, rawContent: "Original todo", item: originalTodo)
